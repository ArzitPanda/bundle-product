...
export const addReducer =(state={products:[],add_id:true},action)=>{
    ...
    if(action.type===add_one)
    {
        ...
        {   if(state.add_id===true)
            {
                state.products =[{add_id:clicked.add_id,id: ele.id, title: ele.title, img: ele.img ,variants:[elem]}]
                
            }
            else
            {
                state.products =[{add_id:uuidv4(),id: ele.id, title: ele.title, img: ele.img ,variants:[elem]}]
            }
            state.add_id=false
        ...
        else
        {
            ...
            {
                state.products =[...state.products,{add_id:uuidv4(),id: ele.id, title: ele.title, img: ele.img ,variants:[elem]}]
            }
